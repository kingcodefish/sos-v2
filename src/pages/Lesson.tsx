...
import les1 from '../lesson1-worldhistory.json';
...
const Problems = () => {
  ...
  return (
    <Drawer>
      ...
      <DrawerContent className="px-10 min-h-[60vh]">
        <DrawerHeader>
        ...
        <DrawerFooter className="flex mb-auto mt-0 flex-col items-center">
...
const Lesson = () => {
  ...
  useEffect(() => {
    window.ipcRenderer.invoke('read-sos-file', searchParams.get('q'))
      .then((data) => {
  ...
  return (
    <div className="text-center w-screen">
      ...
      <button className="fixed top-4 left-4 bg-transparent" onClick={() => {navigate('/')}}>X</button>
